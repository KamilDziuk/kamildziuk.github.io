function ScrollMenu() {
  this.aboutMeText = () => {
    ...
    window.addEventListener("scroll", () => {
      ...
      if (scroll >= document.querySelector("#aboutMePosition").offsetTop) {
        document
          .querySelector(".aboutMeText")
          .classList.add("aboutMeText--scrolling");
        document.querySelector(".aboutMe").classList.add("aboutMe--scrolling");
      } else {
        document
          .querySelector(".aboutMeText")
          .classList.remove("aboutMeText--scrolling");
        document
          .querySelector(".aboutMe")
          .classList.remove("aboutMe--scrolling");
      }
      if (
        scroll >=
        document.querySelector("#portfolioPosition").offsetTop - 100
      ) {
        document
          .querySelector(".aboutMeText")
          .classList.remove("aboutMeText--scrolling");
  ...
  this.projectsText = () => {
    window.addEventListener("scroll", () => {
      ...
      if (scroll >= document.querySelector("#portfolioPosition").offsetTop) {
        document
          .querySelector(".projectsText")
          .classList.add("projectsText--scrolling");
      } else {
        document
          .querySelector(".projectsText")
          .classList.remove("projectsText--scrolling");
      }
  ...
  this.offerText = () => {
    window.addEventListener("scroll", () => {
      ...
      if (scroll >= document.querySelector("#offerPosition").offsetTop) {
        document
          .querySelector(".offerText")
          .classList.add("offerText--scrolling");
        document.querySelector(".offer").classList.add("offer--scrolling");
      } else {
        document
          .querySelector(".offerText")
          .classList.remove("offerText--scrolling");
  ...
  this.cooperationText = () => {
    window.addEventListener("scroll", () => {
      ...
      if (
        scroll >=
        document.querySelector("#cooperationPosition").offsetTop + -100
      ) {
        document
          .querySelector(".cooperationText")
          .classList.add("cooperationText--scrolling");
        document
          .querySelector(".cooperation")
          .classList.add("cooperation--scrolling");
      } else {
        document
          .querySelector(".cooperationText")
          .classList.remove("cooperationText--scrolling");
        document
          .querySelector(".cooperation")
          .classList.remove("cooperation--scrolling");
      }
      if (
        scroll >=
        document.querySelector("#cooperationPosition").offsetTop + 150
      ) {
        document
          .querySelector(".cooperationText")
          .classList.remove("cooperationText--scrolling");
